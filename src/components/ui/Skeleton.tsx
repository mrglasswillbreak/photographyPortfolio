  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-neutral-900">
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="mt-6">
          <TextSkeleton width="w-96 mx-auto" height="h-12" />
        </div>
        <div className="mt-4">
          <TextSkeleton width="w-80 mx-auto" height="h-12" />
        </div>
        <div className="mt-8">
          <TextSkeleton width="w-2/3 mx-auto" height="h-6" />
        </div>
    ...
    <section className="py-20 md:py-32 bg-neutral-50 dark:bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <div className="mt-4">
            <TextSkeleton width="w-64 mx-auto" height="h-10" />
          </div>
          <div className="mt-4">
            <TextSkeleton width="w-96 mx-auto" height="h-5" />
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:pl-8">
            ...
            <div className="mt-4">
              <TextSkeleton width="w-80" height="h-10" />
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="p-8 bg-neutral-50 dark:bg-neutral-900 rounded-sm">
              ...
              <div className="mt-3">
                <TextSkeleton width="w-full" height="h-16" />
              </div>
            </div>
          ))}
        </div>
    ...
    <section className="py-20 md:py-32 bg-white dark:bg-neutral-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <TextSkeleton width="w-24 mx-auto" height="h-4" />
          <div className="mt-4">
            <TextSkeleton width="w-48 mx-auto" height="h-10" />
          </div>
          <div className="mt-4">
            <TextSkeleton width="w-96 mx-auto" height="h-5" />
          </div>
